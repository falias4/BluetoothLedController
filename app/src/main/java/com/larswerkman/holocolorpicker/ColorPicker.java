...
import com.fali.bluetoothledcontroller.R;
/**
...
public class ColorPicker extends View {
	...
	public int getArduinoColor() {
		return mArduinoColor;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (onColorSelectedListener != null) {
				onColorSelectedListener.onColorSelected(mArduinoColor, mColor);
			}
			break;
		}
		return true;
	...
	public void setNewCenterColor(int color) {
		...
		mColor = color;
		mArduinoColor = Color.red(color) << 16 | Color.green(color) << 8 | Color.blue(color);
